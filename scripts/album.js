...
/**
* Don't know if this is the correct terminology, but it seems like the "[ (bracket)" after song: creates a "nested" object?
...
// Variable createSongRow defines as function that takes 3 agrguments: songNumber, songName, songLength.
...
// The album-view-song-item table is closed via the </tr>.
      + '</tr>'
      ;
//The createSongRow function is called via return template; (I tried to console.log this but I wasn't able to).
     return template;
 };
...
/**
* Don't totally understand what's going on here—the description in Checkpoint11 instructions says:
*
...
*
* createSongRow(i + 1, album.songs[i].title, album.songs[i].duration);???  Talk to Junior about this.... Don't totally know whats going on here.
**/
...
// Still need to comment on lines 163-186
